...
extension Card {
    static func createFakeData() -> [Card] {
        ...
        let sentenceCloze1 = SentenceCloze(clozeWord: Word(text: "like", isReview: false, chinese: "像是"), sentence: sentences[0])
        let sentenceCloze2 = SentenceCloze(clozeWord: Word(text: "one", isReview: false, chinese: "一個"), sentence: sentences[1])
